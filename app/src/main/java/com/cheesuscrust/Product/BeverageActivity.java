            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId())
                {
                    case R.id.nav_dashboard :
                        ...
                        Intent intent0 = new Intent(BeverageActivity.this, activity_dash.class);
                    ...
                    case R.id.nav_products :
                        menuItem.setChecked(true);
                        Intent intent2 = new Intent(BeverageActivity.this, HomeActivity.class);
                    ...
                    case R.id.nav_user_profile :
                        menuItem.setChecked(true);
                        Intent intent1 = new Intent(BeverageActivity.this, UserProfile.class);
                    ...
                    case R.id.nav_contact_us :
                        menuItem.setChecked(true);
                        Intent intent3 = new Intent(BeverageActivity.this, ContactActivity.class);
                    ...
                    case R.id.nav_settings :
                        menuItem.setChecked(true);
                        Toast.makeText(BeverageActivity.this, R.string.settings_are_not_available_right_now, Toast.LENGTH_SHORT).show();
                        drawerLayout.closeDrawers();
                        return true;

                    case R.id.nav_logout:
                        AlertDialog.Builder builder = new AlertDialog.Builder(BeverageActivity.this);
                        ...
                        builder.setPositiveButton(getString(R.string.logout), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent3 = new Intent(BeverageActivity.this, WelcomeScreen.class);
                                startActivity(intent3);
                                return;
                            }
                        });
