            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId())
                {
                    case R.id.nav_dashboard :
                        ...
                        Intent intent0 = new Intent(DessertActivity.this, activity_dash.class);
                    ...
                    case R.id.nav_products :
                        menuItem.setChecked(true);
                        Intent intent2 = new Intent(DessertActivity.this, HomeActivity.class);
                    ...
                    case R.id.nav_user_profile :
                        menuItem.setChecked(true);
                        Intent intent1 = new Intent(DessertActivity.this, UserProfile.class);
                    ...
                    case R.id.nav_contact_us :
                        menuItem.setChecked(true);
                        Intent intent3 = new Intent(DessertActivity.this, ContactActivity.class);
                    ...
                    case R.id.nav_settings :
                        menuItem.setChecked(true);
                        Toast.makeText(DessertActivity.this, R.string.settings_are_not_available_right_now, Toast.LENGTH_SHORT).show();
                        drawerLayout.closeDrawers();
                        return true;
                    ...
                    case R.id.nav_logout:
                        ...
                        builder.setPositiveButton(getString(R.string.logout), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent3 = new Intent(DessertActivity.this, WelcomeScreen.class);
                                startActivity(intent3);
                                return;
                            }
                        });
