...
public class UserProfile_UpdateEmail_Dialog extends DialogFragment
{
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(R.string.change_email, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {

                String newEmail = editTextNewEmail.getText().toString();
                data.applyEmail(newEmail);
            }
        });
        ...
        editTextNewEmail = view.findViewById(R.id.userProfile_update_EmailEditText);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            data = (passEmail) context;
        } catch (ClassCastException e) {
            throw new ClassCastException(context.toString() +getString(R.string.must_implement_passEmail));
        }
    }

    public interface passEmail
    {
